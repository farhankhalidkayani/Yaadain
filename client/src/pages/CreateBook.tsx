...
import { addBook, getCurrentUser, getUserProfile } from '@/lib/firebase';
...
const CreateBook = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userProfile && userProfile.subscription !== 'premium' && userProfile.booksCount >= 3) {
        toast({
          title: 'Limit Reached',
          description: 'Free users can only create up to 3 memory books. Please upgrade to premium for unlimited books.',
          variant: 'destructive',
        });
        setIsLoading(false);
        return;
    ...
    <div className="min-h-screen flex flex-col bg-[#FDFBF8] bg-[url('https://www.transparenttextures.com/patterns/paper.png')] bg-fixed">
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-['Playfair_Display'] font-bold text-neutral-900">Create a New Memory Book</h1>
            <p className="text-neutral-700 mt-1">Compile your favorite memories into a beautiful book</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-1">
              ...
              <div className="mt-4">
                <Label htmlFor="cover-image" className="mb-2 block">Book Cover (Optional)</Label>
                <label className="cursor-pointer">
                  <div className="bg-white border border-dashed border-neutral-300 rounded-md p-6 flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-neutral-500 text-center mb-1">
                      {coverImage ? coverImage.name : 'Click to upload a cover image'}
                    </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-4">
                      <p className="text-neutral-500 text-sm mb-6">
                        After creating your book, you'll be able to add memories to it and organize them in any order.
                      </p>
